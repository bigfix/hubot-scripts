# Description:
#   Have Hubot comment in channels when sites monitored by uptime robot are down.
#
# Dependencies:
#   None
#
...
#
# Author:
#   ottumm (based on https://github.com/github/hubot-scripts/blob/master/src/scripts/uptime-robot.coffee)
